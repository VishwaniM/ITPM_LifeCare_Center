      ...
      <div>
        ...
        <header id="header" class="fixed-top">
         <div class="container d-flex align-items-center">
            ...
            <a href="/addTAppDetails" class="appointment-btn scrollto"><span class="d-none d-md-inline">Make an</span> Appointments</a>
            <a href="/loginA" className="login-btn"><span class="d-none d-md-inline"></span> Login</a>
         </div>
      </header>
      </div>
    );
