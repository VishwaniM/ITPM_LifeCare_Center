...
export default class DisplayAppointmentCus extends Component{
    constructor(props){
        super(props);
        ...
        .then(response => {
            response.data.forEach(element => {
                if(element.Username === localStorage.getItem('username')){
                    this.setState({AppDetails: this.state.AppDetails.concat(element)})
                }
            });
   ...
   render(){
       return (
            <div>
                <div class="mt-20 ...">
                    <br/><br/>
            <center><b><h3>Previous Appointments</h3></b></center>
            </div>
